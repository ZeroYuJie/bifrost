...
// GovernanceReader is the slice of the config store governance tools read
// and write. Owned by mcptools for the same reason LogReader is; Warp only
// carries it from the config store to the server's Deps.
