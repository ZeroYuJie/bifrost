...
const FilterSchema = `{
  ...
  "properties": {
    ...
    "providers": {"type": "array", "items": {"type": "string", "minLength": 1}, "minItems": 1, "description": "e.g. openai, anthropic, bedrock."},
    "models": {"type": "array", "items": {"type": "string", "minLength": 1}, "minItems": 1},
    "status": {"type": "array", "items": {"type": "string", "minLength": 1}, "minItems": 1, "description": "success, error, or cancelled."},
    "stop_reasons": {"type": "array", "items": {"type": "string", "minLength": 1}, "minItems": 1, "description": "e.g. stop, length, content_filter, tool_calls. Call describe_filter_space to see which actually occur."},
    "objects": {"type": "array", "items": {"type": "string", "minLength": 1}, "minItems": 1, "description": "Request type, e.g. chat_completion, embedding, speech, transcription, image_generation, video_generation. Use this to exclude non-chat traffic - embeddings, speech, and image/video generation have their own cost and latency shape and otherwise get averaged in with chat requests."},
    "virtual_key_ids": {"type": "array", "items": {"type": "string", "minLength": 1}, "minItems": 1},
    "team_ids": {"type": "array", "items": {"type": "string", "minLength": 1}, "minItems": 1},
    "customer_ids": {"type": "array", "items": {"type": "string", "minLength": 1}, "minItems": 1},
    "user_ids": {"type": "array", "items": {"type": "string", "minLength": 1}, "minItems": 1},
    "business_unit_ids": {"type": "array", "items": {"type": "string", "minLength": 1}, "minItems": 1},
    "project_ids": {"type": "array", "items": {"type": "string", "minLength": 1}, "minItems": 1},
    "apps": {"type": "array", "items": {"type": "string", "minLength": 1}, "minItems": 1},
